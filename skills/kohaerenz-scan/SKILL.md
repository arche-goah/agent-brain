...
```
Workflow({ scriptPath: "core/workflows/kohaerenz-scan.js"
           or reference the script from this file,
           args: { date: "<DATE>", scratch: "<session scratchpad>/kohaerenz-<DATE>" } })
```
...
- Report: `docs/research/kohaerenz-scan/register-<DATE>.md` — prioritized
